...
import { FaCalendarAlt, FaMapMarkerAlt, FaUsers, FaTag, FaDollarSign, FaGlobe, FaTimes } from 'react-icons/fa';

const DashboardEventCard = ({ event, registrationId, onCancelRegistration }) => {
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        {!isPastEvent && (
                            <button
                                ...
                                className="inline-flex items-center justify-center px-3 py-2 bg-red-50 hover:bg-red-100 text-red-600 hover:text-red-700 font-semibold text-sm rounded-lg transition-colors duration-200 hover:shadow-sm"
